...
const MODELS: Record<ModelRole, string> = {
  ...
  // ── Video Generation ──
  [ModelRole.VideoShort]: process.env.MODEL_VIDEO_SHORT || "gen3a_turbo",
  // Provider: Runway ML — uses RUNWAYML_API_KEY directly via HTTP

  [ModelRole.VideoPresenter]: process.env.MODEL_VIDEO_PRESENTER || "heygen-v2",
...
const MODEL_CAPABILITIES: Record<ModelRole, string> = {
  ...
  [ModelRole.VideoShort]: "Short-form video for Reels/TikTok — speed matters",
  [ModelRole.VideoPresenter]:
